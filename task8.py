    ...
    def run(self):
        while self.running:
            ...
            if self.current_role is None:
                ...
                if choice == "1":
                    print("词汇表：")
                    print(self.text_processor.word_freq)
                elif choice == "2":
                    print("前10高频词：")
                ...
                if choice == "1":
                    ...
                    self.text_processor.add_file("data/for_admin/excluded.csv")
                    print("添加完成。")
                elif choice == "5":
                    print("正在移除文件 data/for_admin/excluded.csv ...")
                    self.text_processor.delete_file("data/for_admin/excluded.csv")
                    print("移除完成。")
                elif choice == "6":
                    self.logout()
                elif choice == "0":
